...
public class HighPassClass extends DefaultSignalClass {
    ...
    public static class HighPass extends PassFilter {
        ...
        protected void updateFilter(long t, long l) {
            ...
            double f1 = s_cutoff.get(t, l).getMono() / Apsynth.samplefreq;
            double trband = s_trband.get(t, l).getMono() / Apsynth.samplefreq;
            
            double atten = s_atten.get(t, l).getMono();
            double ripple = s_ripple.get(t, l).getMono();
